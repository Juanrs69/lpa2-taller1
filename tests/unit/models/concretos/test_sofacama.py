...
class TestSofaCama:
    def test_herencia_multiple(self):
        sofa_cama = SofaCama("Sofá Cama Moderno", "Tela", "Gris", 500.0, capacidad_personas=3, tamaño_cama="queen")
    ...
    def test_resolucion_metodos(self):
        sofa_cama = SofaCama("Sofá Cama", "Cuero", "Marrón", 600.0, capacidad_personas=2, tamaño_cama="matrimonial", incluye_colchon=True, mecanismo_conversion="electrico")
